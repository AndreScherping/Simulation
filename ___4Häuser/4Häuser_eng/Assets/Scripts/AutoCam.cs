...
namespace UnityStandardAssets.Cameras
{
    ...
    {
        [SerializeField] private float m_MoveSpeed = 4; // How fast the rig will move to keep up with target's position
        ...
        [SerializeField] private float m_TargetVelocityLowerLimit = 10f;// the minimum velocity above which the camera turns towards the object's velocity. Below this we use the object's forward direction.
